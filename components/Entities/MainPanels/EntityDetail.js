...
const EntityDetail = function(props) {
  ...
  const detail_table = [
    ...
    {value: 'shipping_name', displayName: 'Shipping Contact', type: 'text'},
    {value: 'billing_name', displayName: 'Billing Contact', type: 'text'},
    {value: 'mailing_name', displayName: 'Mailing Contact', type: 'text'},
