  ...
  return (
    <div className={classes.root}>
      <AppBar position="static" color="default">
        ...
        >
          <Tab label={ <span className={classes.tabSpan}><TaskIcon className={classes.icon}/>&nbsp;Tasks</span>} {...a11yProps(0)} />
          <Tab label={ <span className={classes.tabSpan}><MapIcon className={classes.icon}/>&nbsp;Map</span>} {...a11yProps(1)} />
        </Tabs>
      </AppBar>
      <SwipeableViews
