  ...
  //TaskList/Scheduler Props
    ...
    const taskViews = [
      ...
      array: [{text: "Order", field: "priority_order", width: '4%', maxWidth: 150,style: 'smallListItemText', type: 'number'},
              ...
              {text: "Name", field: "t_name", width: '19%', maxWidth: 170, style: 'boldListItemText', type: 'text'},
              ...
              {text: "Install Date", field: "sch_install_date", width: '6%', maxWidth: 100,style: 'installSmallListItemText', type: 'date'},
