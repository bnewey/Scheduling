  ...
  //TaskList/Scheduler Props
    ...
    const taskViews = [
      ...
      array: [//{text: "Order", field: "drill_order", width: (size)=> size == "small" ? '3%' : '2%', maxWidth: 150,style: 'smallListItemText', type: 'number'},
              {text: "WO #", field: "table_id", width: (size)=> size == "small" ? '' : '3%', maxWidth: 40,style: 'smallListItemText', type: 'number', dontShowInSmall: true},
              {text: "Order Date", field: "wo_date", width: (size)=> size == "small" ? '12%' : '7%', maxWidth: 70,style: 'installBoldSmallListItemText', type: 'date', viewOnly: true},
              {text: "Name", field: "t_name", width: (size)=> size == "small" ? '20%' : '24%', maxWidth: 300, style: 'boldListItemText', type: 'text'},
              {text: "State", field: "state", width: (size)=> size == "small" ? '4%' : '3%', maxWidth: 50, style: 'smallListItemText', type: 'text'},
              {text: "Type", field: "type", width: (size)=> size == "small" ? '7%' : '5%', maxWidth: 70,style: 'smallListItemText', type: 'text'},
              {text: "Description", field: "description", width: (size)=> size == "small" ? '' : '17%', maxWidth: 230, style: 'smallListItemText', type: 'text',dontShowInSmall: true},
              ...
              {text: "Arrival Date", field: "wo_arrival_dates", width: (size)=> size == "small" ? '12%' : '7%', maxWidth: 70, style: 'artSignDrillSmallListItemText', type: 'text', dontShowInPdf: true,viewOnly: true},
              {text: "Drill Date", field: "drill_date", width: (size)=> size == "small" ? '18%' : '9%', maxWidth: 120, style: 'drillSmallListItemText', type: 'date'},
    ...
    {name: "Install(No Drill)", value: 1, permission_access: ["crew"],order: 'priority_order',
       array: [//{text: "Order", field: "priority_order", width: (size)=> size == "small" ? '4%' : '2%', maxWidth: 150,style: 'smallListItemText', type: 'number'},
              {text: "WO #", field: "table_id", width: (size)=> size == "small" ? '' : '3%', maxWidth: 40,style: 'smallListItemText', type: 'number',dontShowInSmall: true},
              {text: "Order Date", field: "wo_date", width: (size)=> size == "small" ? '12%' : '7%', maxWidth: 70,style: 'installBoldSmallListItemText', type: 'date', viewOnly: true},
              {text: "Name", field: "customer_name", width: (size)=> size == "small" ? '26%' : '32%', maxWidth: 300, style: 'boldListItemText', type: 'text'},
              {text: 'City', field: 'city', type: 'text', width: s => s==='large'?'12%':'8%', maxWidth: 50, style: 'smallListItemText', type: 'text', dontShowInSmall: true },
              {text: "State", field: "state", width: (size)=> size == "small" ? '8%' : '3%', maxWidth: 50, style: 'smallListItemText', type: 'text', dontShowInSmall: true},
              {text: "Drill Date", field: "drill_date", width: (size)=> size == "small" ? '18%' : '9%', maxWidth: 120, style: 'drillSmallListItemText', type: 'date', disableDrillEdit: true, dontShowInSmall: true},
              {text: "Type", field: "type", width: (size)=> size == "small" ? '10%' : '5%', maxWidth: 70,style: 'smallListItemText', type: 'text'},
    ...
    {name: "Service Dept", value: 2, permission_access: ["service"], order: 'service_order',
       array: [//{text: "Order", field: "service_order", width: (size)=> size == "small" ? '6%' : '4%', maxWidth: 150,style: 'smallListItemText', type: 'number'},
              {text: "WO #", field: "table_id", width: (size)=> size == "small" ? '' : '4%', maxWidth: 40,style: 'smallListItemText', type: 'number',dontShowInSmall: true},
              ...
              {text: "Name", field: "t_name", width: (size)=> size == "small" ? '20%' : '18%', maxWidth: 300, style: 'boldListItemText', type: 'text'},
              {text: "State", field: "state", width: (size)=> size == "small" ? '5%' : '3%', maxWidth: 50, style: 'smallListItemText', type: 'text'},
              {text: "Type", field: "type", width: (size)=> size == "small" ? '8%' : '5%', maxWidth: 70,style: 'smallListItemText', type: 'text'},
              {text: "Description", field: "description", width: (size)=> size == "small" ? '' : '15%', maxWidth: 230, style: 'smallListItemText', type: 'text',dontShowInSmall: true},
    ...
    array: [ 
            ...
            {text: "State", field: "state", width: (size)=> size == "small" ? '4%' : '3%', maxWidth: 50, style: 'smallListItemText', type: 'text'},
            {text: "Type", field: "type", width: (size)=> size == "small" ? '7%' : '5%', maxWidth: 70,style: 'smallListItemText', type: 'text'},
            {text: "Description", field: "description", width: (size)=> size == "small" ? '' : '17%', maxWidth: 300, style: 'smallListItemText', type: 'text',dontShowInSmall: true},
            ...
            {text: "Drill Date", field: "drill_date", width: (size)=> size == "small" ? '18%' : '9%', maxWidth: 120, style: 'drillSmallListItemText', type: 'date', viewOnly: true},
            // {text: "Status", field: "woi_status_check", width: (size)=> size == "small" ? '6%' : '3%', maxWidth: 100, style: 'artSignDrillSmallListItemText', type: 'text', dontShowInPdf: true},
            {text: "Install Date", field: "sch_install_date", width: (size)=> size == "small" ? '12%' : '7%', maxWidth: 100,style: 'installSmallListItemText', type: 'date',  viewOnly: true},
            ]},
    {name: "FP Arrival", value: 5, permission_access: ["crew"],order: 'priority_order',
      array: [//{text: "Order", field: "priority_order", width: (size)=> size == "small" ? '4%' : '2%', maxWidth: 150,style: 'smallListItemText', type: 'number'},
          {text: "WO #", field: "table_id", width: (size)=> size == "small" ? '' : '3%', maxWidth: 40,style: 'smallListItemText', type: 'number',dontShowInSmall: true},
          {text: "Name", field: "t_name", width: (size)=> size == "small" ? '26%' : '32%', maxWidth: 300, style: 'boldListItemText', type: 'text'},
          {text: "State", field: "state", width: (size)=> size == "small" ? '8%' : '3%', maxWidth: 50, style: 'smallListItemText', type: 'text'},
          {text: "Type", field: "type", width: (size)=> size == "small" ? '10%' : '5%', maxWidth: 70,style: 'smallListItemText', type: 'text'},
          {text: "Description", field: "description", width: (size)=> size == "small" ? '' : '21%', maxWidth: 230, style: 'smallListItemText', type: 'text',dontShowInSmall: true},
          //{text: "Status", field: "woi_status_check", width: (size)=> size == "small" ? '' : '10%', maxWidth: 100, style: 'artSignDrillSmallListItemText', type: 'text', dontShowInPdf: true},
          {text: "Arrival Date", field: "wo_arrival_dates", width: (size)=> size == "small" ? '14%' : '8%', maxWidth: 70, style: 'artSignDrillSmallListItemText', type: 'text', dontShowInPdf: true},
          {text: "Status", field: "woi_status_check", width: (size)=> size == "small" ? '10%' : '3%', maxWidth: 100, style: 'artSignDrillSmallListItemText', type: 'text', dontShowInPdf: true},
