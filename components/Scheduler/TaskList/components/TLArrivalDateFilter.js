...
const ArrivalDateFilter = (props) => {
    //PROPS
    const {activeTaskView,taskViews, handleRefreshView, taskListTasksSaved,arrivalDateFilters, setArrivalDateFilters,
    ...
    return(
        <>
                {selectArrivalDateMenuOpen && taskListTasksSaved ? 
                <div className={classes.filterInstallDateDiv}>
                    ...
                    <Select  multiple
                            ...
                            >
                        {(()=> {
                            var array = [...taskListTasksSaved].map((task)=> task["wo_arrival_dates"])
