...
const ColorTable = () => {
    ...
    const [itemColumn, setItemColumn] = React.useState('color');
    ...
    const columns = [
        {id: 'color', label: 'Color Name', minWidth: 20, maxWidth: 150, align: 'left',
    ...
    return (
        <div className={classes.root}>
            ...
            <Table stickyHeader  size="small" aria-label="sticky table">
              ...
              <TableBody>
                {colors && colors.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                  return (
