...
const DescTable = () => {
    ...
    const handleDialogOpen = (edit_value) => {
        ...
        setItemColumn("Description");
    };

    const columns = [
        {id: 'description', label: 'Description', minWidth: 20, maxWidth: 150, align: 'left',
    ...
    return (
        <div className={classes.root}>
            ...
            <Table stickyHeader  size="small" aria-label="sticky table">
              ...
              <TableBody>
                {desc && desc.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                  return (
