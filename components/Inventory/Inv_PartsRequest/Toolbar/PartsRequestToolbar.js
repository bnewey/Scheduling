...
const PartsRequestToolbar = function(props) {
  const {user} = props;

  
  const { partsRequest, setPartsRequest,  currentView, setCurrentView, views} = useContext(ListContext);

  const backMode = currentView && currentView.value != "partsRequestItemsList";
...
export default PartsRequestToolbar
