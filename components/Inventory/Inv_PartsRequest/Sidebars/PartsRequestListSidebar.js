...
const OrdersOutListSidebar = function(props) {
  ...
  const {  currentView, setEditPRIDialogMode, setEditPRIModalOpen  } = useContext(ListContext);
  
  const classes = useStyles(); 

  //const searchOpen = currentView && currentView.value == "partsRequestSearch";

  const handleOpenAddEditPartsRequestModal = () =>{
    setEditPRIDialogMode("add");
    ...
    <div className={classes.root}>
        <div className={classes.newButtonDiv} >
             <Button className={classes.newButton} 
                    ...
                    variant="outlined"
                     onClick={event=> handleOpenAddEditPartsRequestModal()}
                    >
...
export default OrdersOutListSidebar
