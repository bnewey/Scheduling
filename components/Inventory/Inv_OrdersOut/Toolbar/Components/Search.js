...
const Search = function(props) {
  ...
  const { ordersOut, setOrdersOut, ordersOutSearchRefetch, setOrdersOutSearchRefetch, currentView, setCurrentView, views,
  ...
  useEffect(()=>{
    if(currentView.value == 'ordersOutSearch' && savedSearch?.length > 0){
      setOrdersOut(savedSearch)
