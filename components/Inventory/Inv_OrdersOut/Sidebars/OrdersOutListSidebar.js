...
import RecentOrdersOut from './components/RecentOrdersOut';
...
const OrdersOutListSidebar = function(props) {
  ...
  const {  currentView, setEditOrderOutModalMode, setEditOrderOutModalOpen  } = useContext(ListContext);
