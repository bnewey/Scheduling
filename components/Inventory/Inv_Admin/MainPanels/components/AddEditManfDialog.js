...
const AddEditManfDialog = (props) => {
    ...
    const handleAddOrEdit = (event) =>{
        ...
        updateManufacturer["name"] = newName;
        ...
        if(updateManufacturer.id){
            ...
            .catch((error)=> {
                ...
                console.error("Failed to Add manfucturer", error);
                if(refreshFunction){
                    refreshFunction();
                }
                handleDialogClose();
    ...
    return(
        <React.Fragment>          
            <Dialog PaperProps={{className: classes.dialog}} open={addNewManDialog} onClose={handleDialogClose}>
            <DialogTitle className={classes.title}>{manf?.id ? `Edit ${manf.name}` : 'Add New Manufacturer'}</DialogTitle>
                <DialogContent className={classes.content}>
                    ...
                    <DialogActions>
                        ...
                        <Button
                            ...
                            color="secondary"
                            size="medium"
                            className={classes.saveButton} >{manf?.id ? "Update" : "Add"}
                            </Button>
                    </DialogActions> 
...
export default AddEditManfDialog;
